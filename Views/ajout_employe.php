<br>
<?php $this->_t = "Insertion de l'employé" ?>
<?php
    ...
    <label for="nomcomplet">Nom complet <b style="color:red;">*</b></label>
        ...
        <div class="row">
            ...
            <select class="form-control" name="fonction" required>
                    ...
                    <option value="Homme/Femme de Ménage">Homme/Femme de ménage</option>
        ...
        <br>
        <label for="photo">Photo de profil <b style="color:red;">*</b></label>
        <div class="row">
            <div class="col">
        ...
        <script>
            ...
            $("#form").on('submit', (function(e){
                ...
                $.ajax({
                        url:"ajout_employe.php",     // Url to which the request is 
